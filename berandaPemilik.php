        ...
        <nav class="nav">
            <div> 
                ...
                <div class="nav_list"> 
                        ...
                        <br><br><br>
                        <a class="nav_link" style="margin-top:270px;" href="logout.php"> 
        ...
        <h5 style="margin-top:25px;margin-bottom:15px;">Beranda</h5>
            <div class="row-inline">
                <div class="flex-container">
                    <div class="card mb-4" style="border-radius: 10px; width:70%; margin-left:10px; background-color:#FFA63E">
                    <div class="card-body" style="
                        box-shadow: 0px 4px 4px 3px rgba(0, 0, 0, 0.25);
                        border-radius: 10px;">
                        <div class="row align-items-start" >
                            <div class="col" style="width: 20%; margin-left:10px">
                                <img class="img" style="width:50%; margin-left:20px;margin-top:20px;" src="images/chart-bar2.png"/>
                    ...
                    <div class="card mb-4" style="border-radius: 10px; width:70%;  margin-left:40px;  background-color:#6BCC92">
                    <div class="card-body" style="
                        box-shadow: 0px 4px 4px 3px rgba(0, 0, 0, 0.25);
                        border-radius: 10px;">
                        <div class="row align-items-start">
                            <div class="col" style="width: 20%; margin-left:10px">
                                <img class="img" style="width:35%; margin-left:20px;margin-top:20px;" src="images/bag2.png"/>
                ...
                <div class="card mb-4" style="border-radius: 10px; width:70%;  margin-left:40px;  background-color:#E13535">
                    <div class="card-body" style="
                        box-shadow: 0px 4px 4px 3px rgba(0, 0, 0, 0.25);
                        border-radius: 10px;">
                        <div class="row align-items-start">
                            <div class="col" style="width: 20%; margin-left:10px">
                                <img class="img" style="width:35%; margin-left:20px;margin-top:20px;" src="images/info-circle2.png"/>
