                ...
                <div class="flex-container">
                    ...
                    <div class="card-body" style="
                        ...
                        <div class="row align-items-start" align="center" >
                            ...
                            <div class="row" style="width:40%; margin-left:80px;">
                                <a class="btn-laporan" href="laporanPenjualan.php" style="text-decoration:none">Check</a>
                            </div>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="card-body" style="
                        ...
                        <div class="row align-items-start" align="center" >
                            ...
                            <div class="row" style="width:40%; margin-left:80px;">
                                <a class="btn-laporan" href="laporanPendapatan.php" style="text-decoration:none">Check</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-4" style="border-radius: 10px; width:25%;  margin-left:70px;  background-color:#E13535">
                    <div class="card-body" style="
                        ...
                        <div class="row align-items-start" align="center" >
                            ...
                            <div class="row" style="width:40%; margin-left:80px;">
                                <a class="btn-laporan" href="laporanPengeluaran.php" style="text-decoration:none">Check</a>
                            </div>
                        </div>
                    </div>
                </div>
